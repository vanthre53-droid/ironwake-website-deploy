...
// ---------- delivery models (V15.3 — 2026-08-22 owner directive) ----------
// These are bespoke-build engagement models layered on top of the canonical
// 12 services. They are NOT new services — they describe HOW a client can
// commission IronWake to build something custom, including:
//   - custom-website-build: bespoke conversion website beyond the 12-service catalog
//   - custom-saas-build: full SaaS product IronWake designs, builds, deploys, maintains
//   - app-idea-collab: revenue/equity-share collaboration on promising app ideas
// Per V14 §L: 12-service catalog is canonical. Delivery models do not
// inflate it. See evidence/pricing-research-2026-08-22.md for retail anchors.

export const DELIVERY_MODELS = Object.freeze([
  {
    id: 'custom-website-build',
    name: 'Custom Conversion Website Build',
    deliveryClass: 'CUSTOM_SCOPED_READY_NOW',
    description: 'Bespoke conversion-focused website designed, coded and deployed for your business. Apple-grade restraint, copper/ivory identity, full-stack build with CMS, analytics, and integration into your booking/CRM.',
    bestFor: 'Founder-brand businesses, premium local services, lead-gen sites that need to outperform template platforms.',
    anchor: 'Webflow CMS $23-39/mo equivalent at build; agency site-builds on Clutch average $5k-$25k. We scope and quote per project.',
    pricingBoundary: 'Project-based quote from $1,200 / ₹99,000 after a discovery call.',
    cta: 'Brief us on your website'
  },
  {
    id: 'custom-saas-build',
    name: 'Custom SaaS Product Build',
    deliveryClass: 'CUSTOM_SCOPED_READY_NOW',
    description: 'Full multi-tenant SaaS — idea to deployed, paying product. Frontend (Next.js or your stack), backend, auth, billing, multi-tenant data model, observability, deploy. Solo-founder-scoped or small-team-scoped.',
    bestFor: 'Solo founders with a validated niche who need an engineer-of-record to ship the product.',
    anchor: 'Solo-founder SaaS scaffolding typically $25k-$80k on Toptal/Clutch; we offer that range.',
    pricingBoundary: 'Discovery → MVP $8,000 / ₹6,65,000 → full product $25,000-$80,000 / ₹20-65 lakh. Equity-share considered on case-by-case basis.',
    cta: 'Send your SaaS idea'
  },
  {
    id: 'app-idea-collab',
    name: 'App-Idea Collaboration (Revenue / Equity Share)',
    deliveryClass: 'OWNER_APPROVAL_REQUIRED',
    description: 'If you have a strong app/SaaS idea but no engineering co-founder, IronWake will consider building it with you under a revenue-share or equity-share arrangement instead of upfront fees. We evaluate fit, technical merit, market signal and founder commitment before committing.',
    bestFor: 'Domain-expert founders with validated problem, early traction signals, and willingness to co-build.',
    anchor: 'Equity-share builds are common in solo-founder studios (~$2k cash + 15-30% equity on average per industry scans). We calibrate per deal.',
    pricingBoundary: 'No upfront fee for accepted collabs; IronWake takes 15-40% equity or revenue share, scoped per engagement.',
    cta: 'Pitch your app idea',
    honestLimit: 'We do NOT accept unsolicited app ideas without a 1-page brief and at least one validation signal (waitlist, pre-orders, domain-expert credibility).'
  }
]);
