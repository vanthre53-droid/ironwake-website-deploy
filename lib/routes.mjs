...
export const ROUTES = Object.freeze([
  ...
  ...[
    ['aakaaraa-salon-hyderabad-in','AAKAARAA SALON (Hyderabad)','AAKAARAA SALON in Hyderabad, IN'],
    ['above-salons-leeds-uk','Above Salons (Leeds)','Above Salons in Leeds, UK'],
    ['atmos-hair-studio-glasgow-uk','ATMOS hair studio (Glasgow)','ATMOS hair studio in Glasgow, UK'],
    ['bellissimo-nail-studio-mumbai-in','Bellissimo Nail Studio (Mumbai)','Bellissimo Nail Studio in Mumbai, IN'],
    ['bon-vivant-glasgow-uk','Bon Vivant (Glasgow)','Bon Vivant in Glasgow, UK'],
    ['brother-barbers-glasgow-uk','Brother Barbers Glasgow Uk','brother-barbers-glasgow-uk in , '],
    ['byres-road-barbers-glasgow-uk','Byres Road Barbers (Glasgow)','Byres Road Barbers in Glasgow, UK'],
    ['coia-hairdressing-glasgow-uk','Coia Hairdressing (Glasgow)','Coia Hairdressing in Glasgow, UK'],
    ['dapperwolf-glasgow-uk','Dapperwolf (Glasgow)','Dapperwolf in Glasgow, UK'],
    ['dessange-salon-spa-mumbai-in','Dessange Salon & Spa (Mumbai)','Dessange Salon & Spa in Mumbai, IN'],
    ['edition-salon-glasgow-uk','Edition Salon (Glasgow)','Edition Salon in Glasgow, UK'],
    ['enrich-salon-mumbai-in','Enrich Salon (Mumbai)','Enrich Salon in Mumbai, IN'],
    ['eutopia-glasgow-uk','Eutopia (Glasgow)','Eutopia in Glasgow, UK'],
    ['geetanjali-salon-delhi-in','Geetanjali Salon (Delhi)','Geetanjali Salon in Delhi, IN'],
    ['goat-glasgow-uk','Goat (Glasgow)','Goat in Glasgow, UK'],
    ['green-trends-hyderabad-in','Green Trends (Hyderabad)','Green Trends in Hyderabad, IN'],
    ['hely-glasgow-uk','Hely (Glasgow)','Hely in Glasgow, UK'],
    ['hot-tanning-salon-bearsden-glasgow-uk','Hot Tanning Salon Bearsden Glasgow Uk','hot-tanning-salon-bearsden-glasgow-uk in , '],
    ['hot-tanning-salon-watson-st-glasgow-uk','Hot Tanning Salon Watson St Glasgow Uk','hot-tanning-salon-watson-st-glasgow-uk in , '],
    ['jean-claude-olivier-mumbai-in','Jean Claude Olivier (Mumbai)','Jean Claude Olivier in Mumbai, IN'],
    ['lakme-salon-bangalore-in','Lakme Salon (Bangalore)','Lakme Salon in Bangalore, IN'],
    ['lakme-salon-kolkata-in','Lakme Salon (Kolkata)','Lakme Salon in Kolkata, IN'],
    ['luxe-skin-glasgow-uk','Luxe Skin (Glasgow)','Luxe Skin in Glasgow, UK'],
    ['matthew-s-barber-shop-leeds-uk','Matthew S Barber Shop Leeds Uk','matthew-s-barber-shop-leeds-uk in , '],
    ['mr-blonde-glasgow-uk','Mr Blonde Glasgow Uk','mr-blonde-glasgow-uk in , '],
    ['mudd-salon-and-day-spa-mumbai-in','Mudd Salon and Day Spa (Mumbai)','Mudd Salon and Day Spa in Mumbai, IN'],
    ['new-avalon-chennai-in','New Avalon (Chennai)','New Avalon in Chennai, IN'],
    ['o2-spa-bangalore-in','O2 Spa (Bangalore)','O2 Spa in Bangalore, IN'],
    ['quirk-studio-a-luxury-salon-delhi-in','Quirk Studio - A luxury Salon (Delhi)','Quirk Studio - A luxury Salon in Delhi, IN'],
    ['rinky-sandhal-unisex-salon-delhi-in','Rinky Sandhal Unisex Salon (Delhi)','Rinky Sandhal Unisex Salon in Delhi, IN'],
    ['roseberry-spa-delhi-in','Roseberry Spa (Delhi)','Roseberry Spa in Delhi, IN'],
    ['sameerscissor-com-delhi-in','Sameerscissor.com (Delhi)','Sameerscissor.com in Delhi, IN'],
    ['shaakya-body-spa-bangalore-in','Shaakya Body Spa (Bangalore)','Shaakya Body Spa in Bangalore, IN'],
    ['shaakya-salon-spa-bangalore-in','Shaakya Salon & Spa (Bangalore)','Shaakya Salon & Spa in Bangalore, IN'],
    ['sinh-salon-delhi-in','Sinh Salon (Delhi)','Sinh Salon in Delhi, IN'],
    ['soul-space-glasgow-uk','Soul Space (Glasgow)','Soul Space in Glasgow, UK'],
    ["the-gentleman-s-barber-glasgow-uk","The Gentleman's Barber (Glasgow)","The Gentleman's Barber in Glasgow, UK"],
    ['truefitt-hill-prabhadevi-mumbai-in','Truefitt Hill Prabhadevi Mumbai In','truefitt-hill-prabhadevi-mumbai-in in , '],
    ['volume-unisex-salon-glasgow-uk','Volume unisex salon (Glasgow)','Volume unisex salon in Glasgow, UK'],
    ['westend-hair-glasgow-uk','Westend Hair (Glasgow)','Westend Hair in Glasgow, UK'],
  ].map(([slug, name, business]) => ({
    path: `/work/${slug}`,
    title: `${name} — IronWake Work`,
    description: `A portfolio demonstration of missed-call recovery and after-hours booking capture for ${business}. Built with only public business info. Capability proof only, not a client engagement.`,
    parent: '/work', priority: 0.7, changefreq: 'monthly', file: `app/work/${slug}/page.js`, section: 'Work', owner: 'work',
  })),
