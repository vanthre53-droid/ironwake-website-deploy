...
export function classifyAuthError(error) {
  ...
  if (code.includes('invalid_grant') || code.includes('otp_expired') || message.includes('auth code') || message.includes('code verifier') || message.includes('expired')) return 'session_expired';
