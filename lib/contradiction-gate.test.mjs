...
const LOCKED_SHA256 = {
  'app/globals.css': 'f3e0e8d963f83059d1317cd8dcf227b5de3ec0a697ba87ac131790d8f5b8785c', // V15.3 R6-R8 DESIGN_LOCK_BLOCKED — Apple glassmorphism on homepage sections/cards (additive: .section::before ribbon, .system-card / .industry-card blur(28px) saturate(160%) + glass gradient + inset highlight + lift shadow, .trust-grid article glass). Buttons already 999px from R5. Previous SHA 96249fe0... was V15.3 R5 baseline; promoted to R6-R8 baseline. Packet: reports/evidence/DESIGN_LOCK_BLOCKED_GLASSMORPH.md. Rollback: revert SHA + delete the glass additions.
  'app/layout.js': '8e87c742eca87a70ae3d9209068de7cbf4f96eedc5499917aab35661d0cf3ce1', // V15.3 R6 — imported RoundFABStack (Apple-glass WhatsApp wa.me FAB + separated Chat FAB). Previous SHA caef2638... was V3-restored baseline; promoted to V15.3 baseline. Rollback: revert SHA + remove the RoundFABStack import + remove its render line.
