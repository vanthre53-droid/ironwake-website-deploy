...
const LOCKED_SHA256 = {
  'app/globals.css': '96249fe0dd489a44f9c5e458ded98e0c1b7d5da03c754e07e8359b2b2a1e2267', // V15.3 R5 DESIGN_LOCK_BLOCKED — Apple-style rounded buttons (additive 2 lines: comment + `.button, .btn { border-radius: 999px; }` after line 308 group rule). Packet: reports/evidence/DESIGN_LOCK_BLOCKED_BUTTON_RADIUS.md. Previous SHA a259e56c... was V3-restored baseline; promoted to V15.3 baseline. Rollback: revert SHA + delete the 2 added lines.
