/**
 * GoogleIcon — the four-colour Google "G" used by every Continue-with-Google
 * button on IronWake. Sharing this means a single brand-consistency point.
 */

export function GoogleIcon({ size = 18, ...rest }) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" aria-hidden="true" focusable="false" {...rest}>
