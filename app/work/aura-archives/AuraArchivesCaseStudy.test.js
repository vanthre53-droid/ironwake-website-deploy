...
test('Aura Archives case study is labelled demonstration with no external demo link or metrics', async () => {
  const source = await readFile(new URL('./AuraArchivesCaseStudy.js', import.meta.url), 'utf8');
