...
test('Bramble Cafe case study is labelled demonstration with no external demo link or metrics', async () => {
  const source = await readFile(new URL('./BrambleCafeCaseStudy.js', import.meta.url), 'utf8');
