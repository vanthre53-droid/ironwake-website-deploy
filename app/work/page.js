...
const portfolio = [
  ...
  // ── V15-013: 40 personalised competitor-name salon demos REMOVED (V15 §56/§105/§115/§122).
  // Canonical portfolio (9 entries) remains as the only OFFERED_NOW proof under /work/.
