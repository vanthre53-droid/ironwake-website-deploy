  ...
  return <main className="shell">
    ...
    <MotionReveal><section className="section">
      ...
      <div className="system-grid">
        ...
        <article className="system-card"><span className="micro">Current site status</span><h3>No AI receptionist is operating here</h3><p>The corner helper is a deterministic decision tree, not an AI chat, phone, or DM assistant. It does not make calls, send messages, or arrange callbacks.</p></article>
        <article className="system-card"><span className="micro">Provider status</span><h3>No telephony, voice, messaging, or model provider is configured</h3><p>A real deployment would require an approved provider account, a scoped model credential, a phone or messaging route, escalation coverage, and verified callback evidence before it could be described as live.</p></article>
