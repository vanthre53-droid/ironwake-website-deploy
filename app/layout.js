...
import RoundFABStack from './components/RoundFABStack.jsx';
...
export default function RootLayout({ children }) {
  ...
  return <html lang="en"><body><a className="skip-link" href="#main-content">Skip to main content</a><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><ScrollProgress /><main id="main-content" tabIndex={-1}>{children}</main><SiteFooter /><RoundFABStack /><CookieBanner /><ScrollToTop /></body></html>;
}
